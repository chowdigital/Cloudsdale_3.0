...
<div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-5" data-mdb-toggle="animation" data-mdb-animation-start="onLoad" data-mdb-animation="fade-in-up">
  ...
  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/web/stable.png" class="w-100" />
  ...
  <div class="col">
    <div class="card web-card">
    <div class="bg-image hover-overlay hover-zoom hover-shadow ripple">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/web/rapsa.png" class="w-100" />
  <a href="https://rapsa.co.uk/" target="_blank">
    <div class="mask" style="background-color: rgba(57, 192, 237, 0.2)"></div>
  </a>
</div>

      <div class="card-body p-4">
        <h3 class="card-title">Rapsa</h3>
        <p class="card-text">
          Full rebrand including animated logo, modern Filipino fusion experience
        </p>
        <p class="text-primary"><i class="fas fa-desktop"></i>&nbsp;&nbsp;Web Design</p>
        <p class="text-primary"> <i class="fas fa-camera-retro"></i>&nbsp;&nbsp;Photography</p>
  ...
  <div class="col">
    <div class="card web-card">
    <div class="bg-image hover-overlay hover-zoom hover-shadow ripple">
  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/web/threejoes.png" class="w-100" />
  <a href="https://threejoes.co.uk/" target="_blank">
    <div class="mask" style="background-color: rgba(57, 192, 237, 0.2)"></div>
  </a>
</div>

      <div class="card-body p-4">
        <h3 class="card-title">Three Joes</h3>
        <p class="card-text">
          Multi-location pizza restaurant, with interactive online menu. 
        </p>
        <p class="text-primary"><i class="fas fa-desktop"></i>&nbsp;&nbsp;Web Design</p>
        <p class="text-primary"> <i class="fas fa-camera-retro"></i>&nbsp;&nbsp;Photography</p>
  ...
  <!-- one card END -->
    ...
    <div class="card web-card">
    <div class="bg-image hover-overlay hover-zoom hover-shadow ripple">
  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/web/fistral.png" class="w-100" />
  <a href="https://fistralbeachbar.co.uk/" target="_blank">
    <div class="mask" style="background-color: rgba(57, 192, 237, 0.2)"></div>
  </a>
</div>

      <div class="card-body p-4">
        <h3 class="card-title">Fistral Beach Bar</h3>
        <p class="card-text">
        Local beach bar in Cornwall
  ...
  <!-- one card END -->
   ...
   <div class="col">
    <div class="card web-card">
    <div class="bg-image hover-overlay hover-zoom hover-shadow ripple">
  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/web/oldtown.png" class="w-100" />
  <a href="https://oldtowntavern.co.uk/" target="_blank">
    <div class="mask" style="background-color: rgba(57, 192, 237, 0.2)"></div>
  </a>
</div>

      <div class="card-body p-4">
        <h3 class="card-title">Old Town Tavern</h3>
        <p class="card-text">
        London pub with 20 beers on tap and a huge pizza slices
  ...
  <!-- one card END -->
   ...
   <div class="col">
    <div class="card web-card">
    <div class="bg-image hover-overlay hover-zoom hover-shadow ripple">
  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/web/stjohn.png" class="w-100" />
  <a href="https://stjohnstavern.co.uk/" target="_blank">
    <div class="mask" style="background-color: rgba(57, 192, 237, 0.2)"></div>
  </a>
</div>

      <div class="card-body p-4">
        <h3 class="card-title">St John's Tavern</h3>
        <p class="card-text">
       London pub with 20 beers on tap and a Mexican themed menu
        </p>
        <p class="text-primary"><i class="fas fa-desktop"></i>&nbsp;&nbsp;Web Design</p>
        <p class="text-primary"> <i class="fas fa-camera-retro"></i>&nbsp;&nbsp;Photography</p>
  ...
  <!-- one card END -->
   ...
   <div class="col">
    <div class="card web-card">
    <div class="bg-image hover-overlay hover-zoom hover-shadow ripple">
  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/web/lucky.png" class="w-100" />
  <a href="https://theluckyclub.com/" target="_blank">
    <div class="mask" style="background-color: rgba(57, 192, 237, 0.2)"></div>
  </a>
</div>

      <div class="card-body p-4">
        <h3 class="card-title">The Lucky Club</h3>
        <p class="card-text">
       Cocktail Bar and event Space in London
        </p>
        <p class="text-primary"><i class="fas fa-desktop"></i>&nbsp;&nbsp;Web Design</p>
